//! `kmp_view_apply_intent` — move the loom by declaring what it should show.
//!
//! One concept: the declarative intent vocabulary. It is the largest input
//! schema on the surface because it is the whole camera language — focus,
//! clock axis, semantic zoom, dimensions, relation classes, selection, trace,
//! search — and none of it is shared with another verb.

use serde_json::{Value, json};

use crate::protocol::relation_vocabulary::semantic_class_schema;
