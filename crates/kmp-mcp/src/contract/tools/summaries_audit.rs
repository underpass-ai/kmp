...
fn summaries_audit_output_schema() -> Value {
    output_object(json!({
        ...
        "jev": described("object", "On a store opted into TypeSafe Jev: the model, requests and input tokens of the meaning check over this page's standing summaries."),
