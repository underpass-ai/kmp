...
fn trace_search_schema() -> Value {
    ...
    schema["properties"]["same_ref"] = json!({"type":"array","maxItems":4,"items":{"type":"array","minItems":2,"maxItems":8,"uniqueItems":true,"items":{"type":"string","minLength":1}},"description":"With seek, disjoint groups of role names requiring the exact same witness ref. Identity traversal requires an actual evidenced same_entity_as link."});
    schema
}
