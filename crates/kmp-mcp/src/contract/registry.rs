...
use crate::contract::tools::{
    app_view_take_control, app_view_undo, app_visual_projection, ask, condense, curate, ingest,
    inspect, relabel, relate, summaries_audit, time, trace, view_apply_intent, view_get_state,
