...
use kmp_domain::{DimensionSelection, PortError, ResolutionTier};
use kmp_memory_api::{
...
impl EmbeddedKernel {
    ...
    fn observe_recall_quality(&self, rpc: &str, result: &GetContextResult) {
        self.quality_observer().observe(
            ...
            &kmp_domain::QualityObservationContext {
                rpc: rpc.to_owned(),
...
fn recall_view(about: String, result: &GetContextResult) -> MemoryRecallView {
    ...
    MemoryRecallView {
        ...
        rendered: RenderedMemoryView {
            ...
            quality: kmp_memory_api::MemoryQualityView {
...
fn node_view(node: &kmp_domain::BundleNode) -> MemoryNodeView {
    MemoryNodeView {
