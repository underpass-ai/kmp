...
use rehydration_adapter_embedded::{
...
use rehydration_domain::{PortError, QualityMetricsObserver};
use rehydration_observability::{BufferedQualityMetricsObserver, EmbeddedTelemetryGuard};
