...
pub(super) fn proto_semantic_class(
    value: &kmp_domain::RelationSemanticClass,
) -> MemorySemanticClass {
    match value {
        kmp_domain::RelationSemanticClass::Structural => MemorySemanticClass::Structural,
        kmp_domain::RelationSemanticClass::Causal => MemorySemanticClass::Causal,
        kmp_domain::RelationSemanticClass::Motivational => MemorySemanticClass::Motivational,
        kmp_domain::RelationSemanticClass::Procedural => MemorySemanticClass::Procedural,
        kmp_domain::RelationSemanticClass::Evidential => MemorySemanticClass::Evidential,
        kmp_domain::RelationSemanticClass::Constraint => MemorySemanticClass::Constraint,
    }
}
