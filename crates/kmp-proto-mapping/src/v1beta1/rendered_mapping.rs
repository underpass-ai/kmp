use kmp_application::queries::bundle_truncator::TruncationMetadata;
use kmp_application::{GetContextResult, RenderedContext, RenderedTier};
use kmp_domain::BundleQualityMetrics;
use kmp_domain::{KmpMode, ResolutionTier};
...
pub fn proto_rendered_context_v1beta1(
    ...
    ProtoRenderedContext {
        ...
        tiers: rendered
            ...
            .collect(),
        resolved_mode: proto_kmp_mode(rendered.resolved_mode) as i32,
...
fn proto_kmp_mode(mode: KmpMode) -> kmp_proto::v1beta1::RehydrationMode {
    match mode {
        KmpMode::Auto => kmp_proto::v1beta1::RehydrationMode::Unspecified,
        KmpMode::ResumeFocused => kmp_proto::v1beta1::RehydrationMode::ResumeFocused,
        KmpMode::ReasonPreserving => kmp_proto::v1beta1::RehydrationMode::ReasonPreserving,
        KmpMode::TemporalDelta => kmp_proto::v1beta1::RehydrationMode::TemporalDelta,
        KmpMode::GlobalSummary => kmp_proto::v1beta1::RehydrationMode::GlobalSummary,
    }
}
...
fn proto_resolution_tier(tier: ResolutionTier) -> kmp_proto::v1beta1::ResolutionTier {
    match tier {
        ResolutionTier::L0Summary => kmp_proto::v1beta1::ResolutionTier::L0Summary,
        ResolutionTier::L1CausalSpine => kmp_proto::v1beta1::ResolutionTier::L1CausalSpine,
        ResolutionTier::L2EvidencePack => kmp_proto::v1beta1::ResolutionTier::L2EvidencePack,
    }
}
