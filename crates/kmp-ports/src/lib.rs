...
pub use kmp_domain::{
    ...
    GraphReadRevision, GraphRelationMaterializedData, GraphRelationMaterializedEvent,
    IdempotentOutcome, KmpBundle, KmpStats, MemoryAboutIndexReader, NodeDetailMaterializedData,
    NodeDetailMaterializedEvent, NodeDetailProjection, NodeDetailReader, NodeNeighborhood,
