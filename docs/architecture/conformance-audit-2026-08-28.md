...
cargo test --locked -p kmp-release --test plugin_package_contract
cargo test -p kmp-mcp --test plugin_bootstrap --test lifecycle_update
cargo fmt --all -- --check
