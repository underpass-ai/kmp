...
| Unsupported store format | The current binary deliberately opens store format 3 only | Preserve the source and follow the external export/import contract in the embedded recovery runbook. |
