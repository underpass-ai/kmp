  ...
  +------------------------------------------------------------------+
    ...
    +---------------------+              +------------------------+
              ...
              Phase 3: write results to timestamped run directory
                                   |
                                   v
                    archive/artifacts/e2e-runs/YYYY-MM-DD_HHMMSS/
...
```
archive/artifacts/e2e-runs/2026-03-26_201530/
...
# Output directory
export PAPER_OUTPUT_DIR=archive/artifacts/paper-use-cases-qwen3-8b-agent_opus46-judge
